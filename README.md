...
|  |
| <br> <br><br>Complete Crypto App Ui Design on jetpack compose,  app that focuses on crypto world and designed for mobile, tablets.<br><br>• Complete Ui of a crypto app which contain 6-7 screen <br>• Uses many of the [Architecture Components](https://developer.android.com/topic/libraries/architecture): Lifecycle, Navigation<br>• Uses [Hilt](https://dagger.dev/hilt) for dependency injection<br><br>**[> Browse](https://github.com/DeveloperRahnuma/Official_compose-samples/tree/CryptoAppUi)** <br><br>  | <img src="readme/screenshots/Crypto.png" width="320" alt="Crypto App Ui">|
